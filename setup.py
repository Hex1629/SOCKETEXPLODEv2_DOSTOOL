...
type = input("Pls Type Languages only TH, AR, VN, EN or IN ?")
if type.upper() != 'EN' and type.upper() == 'TH' or type.upper() == 'AR' or type.upper() == 'VN' or type.upper() == 'IN':
...
languages = menu_lang()
model = ['PySocks','requests','h2','humanize']
for a in model:
   a2 = '> NUL 2>&1'
