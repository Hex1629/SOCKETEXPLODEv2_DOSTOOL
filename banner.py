...
def methods():
   ...
   for a in data_table:
      ...
      if len(d[3]) > 1000:t2 = d[3]+' '*(4-len(d[3]))
         ...
         t2 = m+' '*(4-len(m))
      r2 = (t,t2)
      banner.append(table_data%(com[0],b,com[1]+a[0],'\x1b[48;5;226m\x1b[38;5;232m'+a[1]+'\x1b[0m','\x1b[48;5;208m\x1b[38;5;255m'+a[2]+'\x1b[0m',color_description+a[3],append_line%(d[0],d[1]+' '*(10-len(d[1])),r2[0],r2[1])))
      count += 1
